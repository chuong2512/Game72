...
public class Key
{
    public const string PACK1 = "game72_pack1";
    public const string PACK2 = "game72_pack2";
    public const string PACK3 = "game72_pack3";
    public const string PACK4 = "game72_pack4";


    public const string PACK1_REGISTER = "register_game72_pack1";
    public const string PACK2_REGISTER = "register_game72_pack2";
    public const string PACK3_REGISTER = "register_game72_pack3";
    public const string PACK4_REGISTER = "register_game72_pack4";
    public const string PACK5_REGISTER = "register_game72_pack5";
}
